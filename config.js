...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/egRrEXH.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'DARKBOT;VINCENT GOMZ;0;https://i.imgur.com/egRrEXH.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝐵𝐿 𝛻𝛪𝛮𝐶𝛯𝛮𝑇",
    BOT_NAME: process.env.BOT_NAME || 'DARKBOT',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝐵𝐿 𝛻𝛪𝛮𝐶𝛯𝛮𝑇;DARK MD BOT;https://i.imgur.com/egRrEXH.jpeg' : process.env.AUDIO_DATA,
